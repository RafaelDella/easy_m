...
<head>
  ...
  <link rel="stylesheet" href="../../assets/form_divida/form_divida.css">
</head>
<body>
  <h1>Gerenciador de Dívidas</h1>
  <form action="create_divida.php" method="POST" onsubmit="return validateForm()">
  ...
  <script src="../../assets/form_divida/form_divida.js"></script>
