...
<head>
  ...
  <link rel="stylesheet" href="../../assets/formulario_divida/formulario_divida.css">
</head>
<body>
  <h1>Gerenciador de Dívidas</h1>
  <formulario action="create_divida.php" method="POST" onsubmit="return validateformulario()">
  ...
  <script src="../../assets/formulario_divida/formulario_divida.js"></script>
