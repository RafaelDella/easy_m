...
<body>
    ...
    <body>
        <main>
            ...
            <form id="formulario" action="salvar_perfil.php" method="POST">
                ...
                <div class="form-step">
                    ...
                    <label><input type="radio" name="melhorar" value="alcançar_metas"> Utilizar meu dinheiro para alcançar minhas
                        metas.</label>
                </div>
                <div class="buttons">
