...
try {
    ...
    mostrarAlerta("DÍVIDAS EXCLUÍDAS", "✅ Todos as dívidas foram excluídas com sucesso!", "1-forms_divida.php");
} catch (PDOException $e) {
    mostrarAlerta("ERRO", "❌ Erro ao excluir dívidass: Por favor, tente novamente mais tarde.", "1-forms_divida.php");
}
