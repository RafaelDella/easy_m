...
try {
    ...
    mostrarAlerta("GASTOS EXCLUÍDOS", "✅ Todos os gastos foram excluídos com sucesso!", "1-forms_gasto.php");

} catch (PDOException $e) {
    mostrarAlerta("ERRO", "❌ Erro ao excluir gastos: Por favor, tente novamente mais tarde.", "1-forms_gasto.php");
}
?>
