...
try {
    ...
    <body>
        <div class="modal-overlay">
            <div class="custom-alert">
                <h2>GASTO EXCLUÍDO</h2>
                <p>✅ Gasto excluído com sucesso!</p>
                <button onclick="window.location.href=\'1-forms_gasto.php\'">Fechar</button>
            </div>
        </div>
    </body>
    </html>';
    ...
    <body>
        <div class="modal-overlay">
            <div class="custom-alert">
                <h2>ERRO</h2>
                <p>❌ Erro ao excluir gasto. Tente novamente mais tarde.</p>
                <button onclick="window.location.href=\'1-forms_gasto.php\'">Fechar</button>
            </div>
        </div>
    </body>
