...
<head>
    ...
    <link rel="stylesheet" href="../../assets/forms_entrada/forms_entrada.css">
</head>
...
<body>
    ...
    <nav id="sidebar">
        <div id="sidebar_content">
            ...
            <ul id="side_items">
                ...
                <li class="side-item"><a href="../view/forms_gasto/formss_gasto.html"><i class="fa-solid fa-sack-xmark"></i><span class="item-description">Novo Gasto</span></a></li>
                ...
                <li class="side-item"><a href="../view/forms_perfil/formss_perfil.html"><i class="fa-solid fa-user"></i><span class="item-description">Teste de Perfil</span></a></li>
                <li class="side-item"><a href="../view/forms_perfil/formss_perfil.html"><i class="fa-solid fa-pager"></i><span class="item-description">Analisar Dívida</span></a></li>
                <li class="side-item"><a href="../view/forms_perfil/formss_perfil.html"><i class="fa-solid fa-circle-dollar-to-slot"></i><span class="item-description">Teto de Gasto</span></a></li>
                <li class="side-item"><a href="../view/forms_perfil/formss_perfil.html"><i class="fa-solid fa-chart-pie"></i><span class="item-description">Gráfico de Pizza</span></a></li>
                <li class="side-item"><a href="../view/forms_perfil/formss_perfil.html"><i class="fa-solid fa-comments-dollar"></i><span class="item-description">Fórum</span></a></li>
                <li class="side-item"><a href="../view/forms_login/forms_login.html"><i class="fa-solid fa-right-from-bracket"></i><span class="item-description">Logout</span></a></li>
            </ul>
        ...
        <div class="top-bar">
            ...
            <div id="confirmModal" class="modal" style="display: none;">
                <div class="modal-content">
                    ...
                    <forms action="deletar_todas_entradas.php" method="POST">
    ...
    <script src="../../assets/forms_entrada/forms_entrada.js"></script>
</body>
</html>
