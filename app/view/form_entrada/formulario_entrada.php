    ...
    <nav id="sidebar">
        <div id="sidebar_content">
            ...
            <ul id="side_items">
                ...
                <li class="side-item active"><a href="formulario_entrada.php"><i class="fa-solid fa-hand-holding-dollar"></i><span class="item-description">Nova Entrada</span></a></li>
                <li class="side-item"><a href="../view/formulario_gasto/forms_gasto.html"><i class="fa-solid fa-sack-xmark"></i><span class="item-description">Novo Gasto</span></a></li>
                <li class="side-item"><a href="../view/formulario_divida/index.php"><i class="fa-solid fa-cash-register"></i><span class="item-description">Nova Dívida</span></a></li>
                ...
                <li class="side-item"><a href="../view/formulário_perfil/forms_perfil.html"><i class="fa-solid fa-user"></i><span class="item-description">Teste de Perfil</span></a></li>
                ...
                <li class="side-item"><a href="../view/formulário_perfil/forms_perfil.html"><i class="fa-solid fa-circle-dollar-to-slot"></i><span class="item-description">Teto de Gasto</span></a></li>
                <li class="side-item"><a href="../view/formulário_perfil/forms_perfil.html"><i class="fa-solid fa-chart-pie"></i><span class="item-description">Gráfico de Pizza</span></a></li>
                <li class="side-item"><a href="../view/formulário_perfil/forms_perfil.html"><i class="fa-solid fa-comments-dollar"></i><span class="item-description">Fórum</span></a></li>
                <li class="side-item"><a href="../view/formulario_login/form_login.html"><i class="fa-solid fa-right-from-bracket"></i><span class="item-description">Logout</span></a></li>
            </ul>
