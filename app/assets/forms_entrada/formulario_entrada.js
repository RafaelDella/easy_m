...
function visualizarEntrada(id) {
    fetch(`http://localhost/easy_m/app/view/forms_entrada/buscar_entrada.php?id=${id}`)
        .then(response => {
            if (!response.ok) {
...
document.getElementById("forms-excluir-todas").submit();
}