document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener("submit", async function (e) {
        ...
        try {
            ...
            const respostaVerificacao = await fetch("../../view/formulario_cadastro/verifica_usuario.php", {
                method: "POST",
            ...
            const respostaCadastro = await fetch("../../view/formulario_cadastro/cadastrar_usuario.php", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                    nome,
            ...
            if (dadosCadastro.sucesso) {
                ...
                window.location.href = "../../view/formulario_login/form_login.html"; // redireciona para login
            } else {
